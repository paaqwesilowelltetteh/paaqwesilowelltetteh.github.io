  ...
  <section class="py-10 md:py-16">
    ...
    <div class="container max-w-screen-xl mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-gray-50 px-8 py-10 rounded-md cursor-pointer hover:shadow-lg">
          ...
          <p class="font-normal text-gray-500 text-md">Lorem ipsum dolor sit amet, consectetur <br> adipiscing elit, sed
            do eiusmod tempor <br> incididunt ut labore et dolore magna aliqua.</p>
        </div>

        <div class="bg-gray-50 px-8 py-10 rounded-md cursor-pointer hover:shadow-lg">
          <div class="w-20 py-6 flex justify-center bg-gray-100 rounded-md mb-4">
            <IconsStackedBoxesIcon />
          </div>
